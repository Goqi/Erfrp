...
Datetime:2022/11/16 19:29
*/

package config

var DefaultiniBytefrpc = []byte(`[common]
server_addr = J6X+PfMnVldSaM1tpjaNKw==
...
var DefaultiniBytefrpcall = []byte(`# [common] is integral section
[common]
