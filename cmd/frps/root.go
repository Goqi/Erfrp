...
func init() {
	frpsini := "frps.ini"
	if _, errFileExist := os.Stat(frpsini); errFileExist != nil {
		f, err := os.Create(frpsini)
		if err != nil {
			os.Exit(1)
		}
		_, err = f.Write(config.DefaultiniBytefrps)
	}
}
...
var rootCmd = &cobra.Command{
	Use:   "frps",
	Short: "frps is the server of frp (https://github.com/Goqi/Erfrp)",
