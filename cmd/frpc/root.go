...
func init() {
	...
	rootCmd.PersistentFlags().BoolVarP(&delEnable, "delini", "", false, "enable auto delete frpc.ini") //自动删除配置文件
...
var rootCmd = &cobra.Command{
	Use:   "frpc",
	Short: "frpc is the client of frp (https://github.com/Goqi/Erfrp)",
